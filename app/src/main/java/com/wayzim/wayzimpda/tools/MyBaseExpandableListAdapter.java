...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            itemHolder.task_id = (TextView) convertView.findViewById(R.id.task_id);//任务号
            itemHolder.tv_name = (TextView) convertView.findViewById(R.id.material_name);//物料名称
            convertView.setTag(itemHolder);
        }else{
            itemHolder = (ViewHolderItem) convertView.getTag();
        }
        itemHolder.task_id .setText(iData.get(groupPosition).get(childPosition).getiId());
